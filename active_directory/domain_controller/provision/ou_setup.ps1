...
#Create OU -- Groups
New-ADOrganizationalUnit -Name "Groups" -Path "DC=animals4life,DC=local"

#Create linux_users, linux_admins, gitlab_users groups in AD
New-ADGroup -Name "linux_users" -SamAccountName linux_users -GroupCategory Security -GroupScope Global -DisplayName "Linux Users" -Path "OU=Groups,DC=animals4life,DC=local" -Description "Members of this group can login the on linux servers"

New-ADGroup -Name "linux_admins" -SamAccountName linux_admins -GroupCategory Security -GroupScope Global -DisplayName "Linux Administrators" -Path "OU=Groups,DC=animals4life,DC=local" -Description "Members of this group can run all the commands on linux servers and act as Administrators"

New-ADGroup -Name "gitlab_users" -SamAccountName gitlab_users -GroupCategory Security -GroupScope Global -DisplayName "Gitlab Users" -Path "OU=Groups,DC=animals4life,DC=local" -Description "Members of this group can login to a4l-git.animals4life.local Gitlab code repository"
